...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <h4 class="header-title">Add &amp; Remove Posts</h4>
            <p class="sub-header">
                ...
                <div class="row">
                    <div class="col-12 text-sm-center form-inline">
                        <div class="form-group mr-2">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#modal-input"><i class="mdi mdi-plus-circle mr-2"></i>Add Post</button>
                        </div>
